...
local myDistTable = {
    "BetterTraits.MedicalMag1", 0.1,
    "BetterTraits.MedicalMag2", 0.1,
    "BetterTraits.MedicalMag3", 0.1,
    "BetterTraits.MedicalMag4", 0.1,
    "BetterTraits.AntiqueMag1", 0.1,
    "BetterTraits.AntiqueMag2", 0.1,
    "BetterTraits.AntiqueMag3", 0.1,
}
