        ...
        if ZombRand(0, 100) <= chance then
            ...
            for i = 0, itterations do
                ...
                elseif roll <= 80 then
                    ...
                    "Base.BeefJerky", "Base.Bread", "Base.Gum", "Base.Strewberrie", "Base.Tomato", "Base.Potato", "Base.Cabbage", "Base.Milk",
                    "Base.CarrotBagSeed", "Base.BroccoliBagSeed", "Base.RedRadishBagSeed", "Base.StrewberrieBagSeed", "Base.TomatoBagSeed", "Base.PotatoBagSeed", "Base.CabbageBagSeed",
